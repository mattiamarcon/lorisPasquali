...
export default function Contatti(){
    return (
        <>
            ...
            <div className="lg:w-1/4 flex flex-col md:h-56 justify-center my-5">
                    <h2 className="font-bold text-3xl text-blue-700 mb-6">INDIRIZZO</h2>
                    <a href="https://www.google.com/maps/dir//Bar+Villeneuve+Piazza+Europa,+10+31040+Mansu%C3%A8+TV/@45.8202778,12.53,17z/data=!4m8!4m7!1m0!1m5!1m1!1s0x47795d5b95324513:0x11f5a394823538fc!2m2!1d12.5300077!2d45.8203317?entry=ttu" className="text-xl underline underline-offset-2 hover:text-blue-500 cursor-pointer " target="_blank">VIA PER ODERZO,12-31040 Mansuè(TV)</a>
                </div>
                <div className=" md:border-black md:border-l-4 lg:w-1/4 flex flex-col md:h-56 justify-center my-5">
                    <h2 className="font-bold text-3xl text-blue-700 mb-6">TELEFONO</h2>
                    <a href="tel:+393920142460" rel="noopener noreferrer" className="text-xl underline underline-offset-2 hover:text-blue-500 cursor-pointer">123 456 7890</a>
                </div>
                <div className=" md:border-black md:border-l-4 lg:w-1/4 flex flex-col md:h-56 justify-center my-5">
                    <h2 className="font-bold text-3xl text-blue-700 mb-6">MAIL</h2>
                    <a href="mailto:provamail@mail.com" rel="noopener noreferrer" className="text-xl underline underline-offset-2 hover:text-blue-500 cursor-pointer">provamail@mail.com</a>
                </div>
            </div>
            </StandardPage >
        </>
...
/*
     <div className="flex flex-col m-4">
                ...
                <div className="flex flex-row w-full justify-center text-center p-2 ">
                    <h2 className="font-bold text-xl whitespace-pre">Email: </h2>
                    <a href="mailto:provamail@mail.com" rel="noopener noreferrer" className="text-xl underline underline-offset-2 hover:text-blue-500 cursor-pointer">provamail@mail.com</a>
                </div>
    </div>
*/