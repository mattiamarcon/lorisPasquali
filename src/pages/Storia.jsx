      ...
      <>
        <StandardPage>
          <div className="grid place-items-center relative text-center">
            <img src="famigliaConCasa.png" alt="" className="w-full opacity-70 h-24 object-cover" />
            <h1 className="absolute text-4xl font-bold">I NOSTRI VALORI</h1>
          </div>
          <div className="flex flex-col xl:flex-row p-3 w-full justify-evenly mt-8">
            ...
            <img src="foto2.png" alt="" className="xl:w-1/2 h-[260px] sm:h-[300px] md:h-[400px] lg:h-[450px] xl:h-[500px] w-11/12 md:w-9/12 mx-auto mb-3 "/>
          </div>
          <hr />
